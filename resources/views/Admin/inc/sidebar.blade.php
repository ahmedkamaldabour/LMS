    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu active">
                <a href="{{ route('admin.auth.index') }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu">
                <a href="#apps" data-bs-toggle="dropdown" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        ...
                        <span>{{__('category.categories')}}</span>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="apps" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.category.index')}}"> {{__('category.all_categories')}} </a>
                    </li>
                    <li>
                        <a href="{{route('admin.category.create')}}"> {{__('category.create')}} </a>
                    </li>
                </ul>
            ...
            <li class="menu">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="components" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.courses.index')}}"> {{__('courses.all_courses')}} </a>
                    </li>
                    <li>
                        <a href="{{route('admin.courses.create')}}"> {{__('courses.add_new')}} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="elements" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.lessons.index')}}">  {{__('lesson.lessons')}} </a>
                    </li>

                    <li>
                        <a href="{{route('admin.lessons.create')}}">  {{__('lesson.create')}} </a>
                    </li>
            ...
            <li class="menu">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="tables" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.blog_category.index')}}"> Blog Categories </a>
                    </li>
                    <li>
                        <a href="{{route('admin.blog_category.create')}}">Create Blog Category </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="forms" data-bs-parent="#accordionExample">
                    <li>
                        ...
                        <a href="{{route("admin.posts.index")}}"> {{__("posts.all_posts")}} </a>
                    </li>
                    <li>
                        <a href="{{route("admin.posts.create")}}"> {{__("posts.add_post")}} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="pages" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{route('admin.comments.index')}}"> {{__('comment.comments')}} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="forms" data-bs-parent="#accordionExample">
                    <li>
                        ...
                        <a href="{{route("admin.exams.index")}}"> {{__("exams.all_exams")}} </a>
                    </li>
                    <li>
                        <a href="{{route("admin.exams.create")}}"> {{__("exams.add_exam")}} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                <a href="#forms" data-bs-toggle="dropdown" aria-expanded="false" class="dropdown-toggle">
                    ...
                    <div class="">
                        <span>{{__("examQuestions.examQuestions")}}</span>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="dropdown-menu submenu list-unstyled" id="forms" data-bs-parent="#accordionExample">
                    <li>
                        ...
                        <a href="{{ route('admin.examQuestions.index') }}">{{ __('examQuestions.examQuestions') }}</a>
                    </li>

                    <li>
                        <a href="{{route("admin.examQuestions.create")}}"> {{__("examQuestions.CreateExamQuestions")}} </a>
                    </li>

                    <li>
                        <a href="{{route('admin.question_answer.index')}}"> Question Answers </a>
                    </li>

                    <li>
                        <a href="{{route('admin.question_answer.create')}}"> Add Question Answer </a>
                    </li>
