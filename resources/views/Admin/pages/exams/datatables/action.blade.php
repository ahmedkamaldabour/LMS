<a href="{{route('admin.exams.show', $exam)}}" class="btn btn-primary mr-2" data-toggle="tooltip"
...
<a href="{{route('admin.exams.edit', $exam)}}" class="btn btn-success mr-2" data-toggle="tooltip"
...
<form id="delete" action="{{ route('admin.exams.delete', $exam) }}" method="post" class="d-inline-block">
    @csrf
    @method('DELETE')
