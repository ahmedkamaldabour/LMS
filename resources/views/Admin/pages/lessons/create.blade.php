                ...
                <div class="breadcrumb-wrapper-content  mb-5 mt-3 d-flex justify-content-start bg-light">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.lessons.index') }}">{{ __('lesson.lessons') }}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ __('lesson.add') }}</li>
                        </ol>
                    </nav>
                </div>
                <!--  END BREADCRUMBS  -->
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4 class="text-center"> {{__('lesson.add')}} </h4>
                                <style>
                                    h4 {
                    ...
                    <div class="card">
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <form method="POST" enctype="multipart/form-data"
                                ...
                                <button type="submit" class="btn btn-primary mt-3">{{__('lesson.create')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
