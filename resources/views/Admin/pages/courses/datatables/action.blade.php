<a href="{{route('admin.courses.show', $course)}}" class="btn btn-primary mr-2" data-toggle="tooltip"
...
<a href="{{route('admin.courses.edit', $course)}}" class="btn btn-success mr-2" data-toggle="tooltip"
...
<form id="delete" action="{{ route('admin.courses.delete', $course) }}" method="post" class="d-inline-block">
    @csrf
    @method('DELETE')
