                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4 class="text-center m-4"> {{__('courses.edit_course')}} </h4>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="widget-content widget-content-area">
                            ...
                            <form action="{{route('admin.courses.update',$course)}}" method="post"
                                ...
                                @method('PUT')
                                <div class="card-body">
                                    @include('Admin.pages.courses.inc._form')
                                </div>
                                <div class="card-footer text-center">
                                    <input type="submit" value="{{__('courses.edit_course')}}"
...
@push('js')
    ...
    @foreach(LaravelLocalization::getSupportedLanguagesKeys() as $key_of_lang)
        <script>
            new SimpleMDE({
                element: document.getElementById("requirements_{{$key_of_lang}}"),
                spellChecker: false,
            });
        </script>
    @endforeach
