                ...
                <div class="breadcrumb-wrapper-content  mb-5 mt-3 d-flex justify-content-start bg-light">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('blog_category.edit') }}</li>
                        </ol>
                    </nav>
                </div>
                <!--  END BREADCRUMBS  -->
                ...
                <div class="statbox widget box box-shadow mt-lg-5">
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4 class="text-center"> {{__('blog_category.edit')}} </h4>
                                <style>
                                    h4 {
                                        font-style: normal;
                                        font-size: 30px;
                    ...
                    <div class="card">
                        <div class="widget-content widget-content-area">
                            ...
                            <form action="{{route('admin.blog_category.update',$category)}}" method="post">
                                @method('PUT')
                                <div class="card-body">
                                    @include('Admin.pages.blog.category.inc._form')
                                </div>
                                <div class="card-footer text-center">
                                    <button class="btn btn-success"> {{__('blog_category.update_category')}} </button>
                                </div>
                            </form>
                        </div>
                    </div>
