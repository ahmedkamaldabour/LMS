                ...
                <div class="breadcrumb-wrapper-content  mb-5 mt-3 d-flex justify-content-start bg-light">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('posts.edit') }}</li>
                        </ol>
                    </nav>
                </div>
                <!--  END BREADCRUMBS  -->
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4 class="text-center"> {{__('posts.edit')}} </h4>
                                <style>
                                    h4 {
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <form action="{{route('admin.posts.update',$post)}}"  enctype="multipart/form-data" method="post">
                                ...
                                <div class="card-footer text-center">
                                    <button class="btn btn-success"> {{__('posts.edit')}} </button>
                                </div>
                            </form>
                        </div>
                    </div>
