            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="breadcrumb-wrapper-content  mb-5 mt-3 d-flex justify-content-start bg-light">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">{{ __('comment.home') }}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ __('comment.comment') }}</li>
                        </ol>
                    </nav>
                </div>
                <!--  END BREADCRUMBS  -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h2 class="card-title">{{__('comment.comment')}}</h2>
                            </div>
                        </div>
                        <div class="card-body">
