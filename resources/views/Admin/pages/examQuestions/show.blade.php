...
@push('css')
    ...
    <link href="{{ asset('assetsAdmin') }}/src/assets/css/light/elements/custom-pagination.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assetsAdmin') }}/src/assets/css/light/apps/blog-post.css">

    <link href="{{ asset('assetsAdmin') }}/src/assets/css/dark/elements/custom-pagination.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assetsAdmin') }}/src/assets/css/dark/apps/blog-post.css">
    <!--  END CUSTOM STYLE FILE  -->

@endpush

@section('title')
    {{__('examQuestions.show')}} | {{ $examQuestion->question }}
@endsection
            ...
            <div class="layout-px-spacing">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="breadcrumb-wrapper-content  mb-5 mt-3 d-flex justify-content-start bg-light">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">{{ __('examQuestions.home') }}</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.examQuestions.index') }}">{{ __('examQuestions.examQuestions') }}</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{ __('examQuestions.show') }}</li>
                            </ol>
                        </nav>
                    </div>
                                ...
                                <div class="featured-image">
                                    ...
                                    <div class="post-header">
                                        <div class="post-title">
                                            <h1 class="mb-0">{{ $examQuestion->exam->name }}</h1>
                                        </div>
                                        <div class="post-meta-info d-flex justify-content-between">
                                            <div class="media">
                                                <img src="{{ $examQuestion->exam->admin->profile->image }}" alt="profile">
                                                <div class="media-body">
                                                    <h5>{{ $examQuestion->exam->admin->name }}</h5>
                                                    <p>{{ $examQuestion->created_at }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
