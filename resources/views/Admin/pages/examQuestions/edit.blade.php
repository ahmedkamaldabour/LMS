...
@section('title')
    {{__('examQuestions.edit')}} | {{ $examQuestion->question }}
@endsection
...
@push('css')
    ...
    <link href="{{ asset('assetsAdmin') }}/src/plugins/css/light/filepond/custom-filepond.css" rel="stylesheet"
          type="text/css"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('assetsAdmin') }}/src/plugins/css/light/editors/quill/quill.snow.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('assetsAdmin') }}/src/plugins/css/light/tagify/custom-tagify.css">
                    ...
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">{{ __('examQuestions.edit') }}</li>
                        </ol>
                    </nav>
                </div>
                <form action="{{ route('admin.examQuestions.update',$examQuestion) }}" method="post"
                                ...
                                <div class="row mb-4">
                                    <div class="col-xxl-24">
                                        ...
                                        <textarea name="question" class="form-control" id="post-meta-description"
                                                  cols="10"
                                                  rows="5">{{ old('question') ?? $examQuestion->question }}</textarea>
                                    </div>
                                </div>
                                @error('question')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-12 mb-4">
                                        <div class="switch form-switch-custom switch-inline form-switch-primary">
                                            <input class="switch-input" name="active" type="checkbox" role="switch"
                                                   id="showPublicly" {{ $examQuestion->active === 1 ? 'checked' : ''  }} >
                                            <label class="switch-label" for="showPublicly">
                                                {{ $examQuestion->active == 1 ?  __('examQuestions.active') : __('examQuestions.inActive')   }}
                                            </label>
                                        </div>
                                    </div>
                                    @error('active')
                                    ...
                                    <div class="col-xxl-12 col-md-12 mb-4">
                                        ...
                                        <select class="form-control" name="exam_id">
                                            ...
                                            @foreach ($exams as $exam)
                                                <option
                                                    value="{{ $exam->id }}" @selected(old('exam_id', $examQuestion->exam_id) == $exam->id)>{{ $exam->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="d-flex">
                                        <div class="usr-img-frame mr-3 rounded-circle">
                                            <img alt="avatar"
                                                 style="width: 30px;height:30px;border-radius:25px;margin-bottom:20px;"
                                                 src="{{ old('question_image') ?? asset($examQuestion::PATH_IMAGE.$examQuestion->question_image) }}">
                                        </div>
                                    </div>
