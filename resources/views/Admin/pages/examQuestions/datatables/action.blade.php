<a href="{{route('admin.examQuestions.show', $examQuestions)}}" class="btn btn-primary mr-2" data-toggle="tooltip"
...
<a href="{{route('admin.examQuestions.edit', $examQuestions)}}" class="btn btn-success mr-2" data-toggle="tooltip"
...
<form id="delete" action="{{ route('admin.examQuestions.destroy', $examQuestions) }}" method="post" class="d-inline-block">
    @csrf
    @method('DELETE')
